...
[![GitHub](https://img.shields.io/badge/GitHub-181717?style=for-the-badge&logo=github&logoColor=white)](https://github.com/mattjaikaran)

</div>

## About Me

Full-stack software engineer in NYC building robust APIs, modern web apps, native mobile experiences, and audio plugins. I work across the entire stack — from low-level DSP in C++ to production ML pipelines — and I ship fast using AI-augmented workflows.
...
- **AI-Powered Products** — LLM integrations, RAG pipelines, agentic workflows, and AI-augmented developer tooling
- **Audio Plugins** — VST3/AU plugins in C++/JUCE for music production and sound design
- **CLIs & Developer Tools** — Fast, ergonomic command-line tools in Rust and Python
- **Native iOS/macOS Apps** — SwiftUI apps with async/await, Core Data, and system integrations

## Current Interests

- AI-augmented software development and agentic coding workflows
- Audio DSP — synthesizers, effects, and real-time signal processing
